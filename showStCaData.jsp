...
<table class="table table-striped">
	...
	<tbody>
		<tr >
			<td>实验号recordID</td>
			<td><input  value="${standupCaData.recordID}" disabled="disabled"  class="form-control"  ></td>
			
		</tr>
		<tr>
			<td>用户号uesrID</td>
			<td><input  value="${standupCaData.userID}" disabled="disabled"  class="form-control"  ></td>
		</tr>
		<tr  >
			<td>开始时间</td>
			<td><input  value="${standupCaData.starttime}" disabled="disabled"  class="form-control"  ></td>
		</tr>
		<tr  >
			<td>rawPath</td>
			<td><input  value="${standupCaData.rawPath}" disabled="disabled"  class="form-control"  ></td>
		</tr>
		<tr  >
			<td>dbpCuff</td>
			<td><input  value="${standupCaData.dbpCuff}" disabled="disabled"  class="form-control"  ></td>
		</tr>
		<tr  >
			<td>sbpCuff</td>
			<td><input  value="${standupCaData.sbpCuff}" disabled="disabled"  class="form-control"  ></td>
		</tr>
